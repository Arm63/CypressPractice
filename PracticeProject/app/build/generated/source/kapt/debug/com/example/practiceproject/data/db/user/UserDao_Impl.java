...
import com.example.practiceproject.data.model.User;
...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `USER_TABLE` (`id`,`username`,`email`) VALUES (?,?,?)";
      }
  ...
  @Override
  public Object insertUsers(final List<User> users, final Continuation<? super Unit> p1) {
      ...
      public List<User> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new User(_tmpId,_tmpUsername,_tmpEmail);
            _result.add(_item);
          }
          return _result;
        } finally {
